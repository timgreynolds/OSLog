...
/// <see href="https://developer.apple.com/documentation/os/oslogtype">Apple Unified Logging OSLogType enum.</see>
public enum OSLogType : uint
{
    /// <see href="https://developer.apple.com/documentation/os/oslogtype/2320721-default">Apple Unified Logging OSLogType default.</see>
    OS_LOG_TYPE_DEFAULT = 00,
    /// <see href="https://developer.apple.com/documentation/os/oslogtype/2320719-info">Apple Unified Logging OSLogType info.</see>
    OS_LOG_TYPE_INFO = 01,
    /// <see href="https://developer.apple.com/documentation/os/oslogtype/2320717-debug">Apple Unified Logging OSLogType debug.</see>
    OS_LOG_TYPE_DEBUG = 02,
    /// <see href="https://developer.apple.com/documentation/os/oslogtype/2320727-error">Apple Unified Logging OSLogType error.</see>
    OS_LOG_TYPE_ERROR = 10,
    /// <see href="https://developer.apple.com/documentation/os/oslogtype/2320725-fault">Apple Unified Logging OSLogType fault.</see>
    OS_LOG_TYPE_FAULT = 11
}

/// <summary>
/// Class that provides native library access to Apple's Unified Logging framework.
/// </summary>
/// <remarks>
/// This class can be used to provide access to Apple's Unified Logging framework in Dotnet projects that target macOS (Cocoa), MacCatalyst, Xamarin, and Maui. 
/// </remarks>
public static class OSLogger
{
    /// <summary>
    /// Extension method that returns the <see cref="OSLogType" /> corresponding to the LogLevel.
    /// </summary>
    public static OSLogType LogType(this LogLevel logLevel)
    {
        return GetOsLogType(logLevel);
    }
    ...
    /// A pointer to this object must be passed to each of the other methods defined on this class.
    /// <br />The Apple documentation defines <paramref name="category"/> and <paramref name="subsytem"/> in a way that seems backwards. Traditionally when used with an ILoggerProvider it is the category that is the reverse DNS notation name.
    /// </remarks>
    /// <param name="subsytem">Apple documentation defines subsystem this way:<br />An identifier string, in reverse DNS notation, that represents the app subsystem that’s logging information, such as com.your_company.your_subsystem_name. The logging system uses this information to categorize and filter related log messages, and to group related logging settings.</param>
    ...
    /// <returns>A pointer to the created native OSLog object.</returns>
    ...
    /// </summary>
    /// <param name="logPtr">Pointer to a native OSLog object created with the <see cref="Create"/>Create</param> method.
    /// <param name="type">The <see cref="OSLogType"/>to check.</param>
    ...
    /// </summary>
    /// <param name="logPtr">Pointer to a native OSLog object created with the <see cref="Create"/>Create</param> method.
    /// <param name="type">The message’s <see cref="OSLogType">log level,</see> which determines the severity of the message and whether the system persists it to disk.</param>
