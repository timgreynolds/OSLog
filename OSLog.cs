...
public static class OSLog
{
    ...
    [DllImport("libUnifiedLoggingNative.dylib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "Create")]
    public static extern IntPtr Create(string subsytem, string category);

    [DllImport("libUnifiedLoggingNative.dylib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "LogTypeEnabled")]
    public static extern bool LogTypeEnabled(IntPtr logPtr, OSLogType type);

    [DllImport("libUnifiedLoggingNative.dylib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "Log")]
    public static extern void Log(IntPtr logPtr, OSLogType type, string message);

    [DllImport("libUnifiedLoggingNative.dylib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "LogTrace")]
    public static extern void LogTrace(IntPtr logPtr, string message);

    [DllImport("libUnifiedLoggingNative.dylib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "LogDebug")]
    public static extern void LogDebug(IntPtr logPtr, string message);

    [DllImport("libUnifiedLoggingNative.dylib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "LogInfo")]
    public static extern void LogInformation(IntPtr logPtr, string message);

    [DllImport("libUnifiedLoggingNative.dylib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "LogWarning")]
    public static extern void LogWarning(IntPtr logPtr, string message);

    [DllImport("libUnifiedLoggingNative.dylib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "LogError")]
    public static extern void LogError(IntPtr logPtr, string message);

    [DllImport("libUnifiedLoggingNative.dylib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "LogCritical")]
    public static extern void LogCritical(IntPtr logPtr, string message);

    [DllImport("libUnifiedLoggingNative.dylib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "LogDefault")]
